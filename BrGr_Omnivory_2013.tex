...
Sciences, 6044 Gilman, Hanover NH 03602,
...
destabilizing at high attack rates on autotrophs, but
stabilizing at low attack rates on autotrophs, compared to herbivory- or detritivory-only models. Together our results demonstrate that multi-channel feeding is common across ecosystems and may be a
...
predation and the resource pool critical to nutrient cycling may
...
higher versus lower trophic levels. Recent theory suggests that predators linking distinct energy
sources should occur at higher trophic levels in food webs
...
data used here however allows tests of the commonness or rarity of
...
\emph{Methods}\\
\\
\indent We first examined data from real food webs to quantify study the prevalence and
...
\\
\indent We calculated estimates of the trophic level
...
systems \citep{Cebrian:2004}. We used a Type II functional response for realism and because Type I functional responses did not allow analytical solutions (due to the nutrient recycling and omnivory aspects of the model).
\\ 
\indent We designed the equations to be in
expressed in units of the most limiting nutrient (here, \(gN m^{-2}  y^{-1}\)
for a terrestrial system and \(\mu gP L^{-1}
d^{-1}\) for a freshwater system). We used literature values from grassland
...
these ranges. While some studies have found higher quality detritus in aquatic systems result in higher assimilation and production efficiencies compared to terrestrial systems \citep{Cebrian:2004,Cebrian:2009hg}, our values do not reveal such a pattern. 
...
(terrestrial or freshwater) and the rates at which omnivores attack living
autotrophs versus detritus. In both system types, models with multi-channel feeding produced fewer parameter sets generating stable models compared to models without such omnivory (Table 2, comparisons to herbivory- and detritivory-only models). 
\newline
...
models and the most-resilient pure-herbivory models. Additionally, in terrestrial
...
multi-channel feeding generally produced less resilient systems, compared to models without multi-channel feeding. Return times in models with multi-channel feeding were twice as high as herbivory-only models (which tended to produce systems with the fastest return times) and 50\% higher than detritivory-only models (Table 2). 
\newline
...
consumer interactions with the detrital web \citep{Moore:2004}. Thus, while our modeling work showed detritivory-only or herbivory-only systems may be the most stable (Table 2), our empirical web findings suggest that such systems are highly unrealistic.
\\
\\
...
stable webs. Such models, however, produced generally the fewest stable systems, compared to detritivory-only models, which produced only stable systems, and herbivory-only systems (Table 2). While return times were higher for multi-channel consumer models compared to herbivory-only, we found that multi-channel feeding could have a stabilizing effect in both terrestrial and freshwater parameter sets, even without the stabilizing forces of
...
multi-channel consumers in real webs may tend to consume a highly mixed
diet (Figures 1-2), the key for system stability may lie in asymmetric
attack rates. Thus, our results may unite the findings that (1) multi-channel feeding can be
...
systems is often highly allochthonous, derived from the lower
...
state of California, and in part conducted while EMW was an EPA STAR
