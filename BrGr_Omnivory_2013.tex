...
multi-channel feeding generally produced less resilent systems, compared to models without multi-channel feeding. Return times in models with multi-channel feeding were twice as high as herbivory-only models (which tended to produce systems with the shortest return times) and 50\% higher than detritivory-only models (Table 2). 
\newline
